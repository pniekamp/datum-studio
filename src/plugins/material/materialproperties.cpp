...
void MaterialProperties::edit(Studio::Document *document)
{
  ...
  connect(&m_document, &MaterialDocument::document_changed, this, &MaterialProperties::refresh);
  connect(&m_document, &MaterialDocument::dependant_changed, this, &MaterialProperties::refresh);
