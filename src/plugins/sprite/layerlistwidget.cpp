...
void LayerListWidget::edit(Studio::Document *document)
{
  ...
  connect(&m_document, &SpriteSheetDocument::document_changed, this, &LayerListWidget::refresh);
  connect(&m_document, &SpriteSheetDocument::dependant_changed, this, &LayerListWidget::refresh);
